      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { src: '/images/realisations/01-salon-parisien-bibliotheque.jpg', alt: 'Salon bibliothèque Versailles' },
              { src: '/images/realisations/13-bureau-dressing.jpg', alt: 'Bureau dressing Versailles' },
              { src: '/images/realisations/15-chambre-niche-led.jpg', alt: 'Chambre Versailles' },
            ].map((img) => (
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed font-light italic mb-6">
            &ldquo;Nous avons confié à Espace Design la rénovation de notre appartement du XVIIIe siècle dans le quartier Notre-Dame. Patrick a magnifiquement restauré les parquets anciens et les moulures tout en créant une salle de bain contemporaine. Un équilibre délicat parfaitement réussi.&rdquo;
          </p>
          <div className="text-sm font-medium text-[#1C1C1C]">Anne-Sophie & Bertrand C.</div>
          <div className="text-xs text-gray-400 font-light mt-0.5">Versailles · Quartier Notre-Dame</div>
        </div>
      </section>
