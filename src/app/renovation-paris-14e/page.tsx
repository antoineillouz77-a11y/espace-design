      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { src: '/images/realisations/11-chambre-dressing.jpg', alt: 'Chambre dressing Paris 14e' },
              { src: '/images/realisations/06-salon-eclairage-theatre.jpg', alt: 'Salon éclairage Paris 14e' },
              { src: '/images/realisations/15-chambre-niche-led.jpg', alt: 'Chambre niche LED Paris 14e' },
            ].map((img) => (
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed font-light italic mb-6">
            &ldquo;Patrick a entièrement rénové notre appartement Rue Pernety. Gros travaux : abattement de cloisons, refonte de la salle de bain, nouvelle cuisine. Il a su respecter notre budget tout en nous livrant un résultat haut de gamme. Équipe sérieuse et ponctuelle.&rdquo;
          </p>
          <div className="text-sm font-medium text-[#1C1C1C]">Antoine & Lucie F.</div>
          <div className="text-xs text-gray-400 font-light mt-0.5">Paris 14e · Quartier Pernety</div>
        </div>
      </section>
