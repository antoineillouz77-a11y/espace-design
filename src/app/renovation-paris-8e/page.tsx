...
const schemaBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Paris 8e', item: 'https://espacedesignparis.fr/renovation-paris-8e' },
  ],
}
...
const schemaFaq = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Quel est le délai pour obtenir un devis dans le 8e arrondissement ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Nous répondons à toutes les demandes de devis sous 48h. Le déplacement pour évaluer votre projet est gratuit et sans engagement dans tout le 8e arrondissement.',
      },
    },
    {
      '@type': 'Question',
      name: 'Quel est le prix d\'une rénovation complète dans le 8e arrondissement ?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Quels types de travaux réalisez-vous dans le 8e arrondissement ?',
      acceptedAnswer: {
        '@type': 'Answer',
  ...
  return (
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="font-display text-2xl sm:text-3xl font-semibold text-[#1C1C1C] mb-10">
            Une réalisation dans le 8e
          </h2>
          <div className="relative rounded-xl overflow-hidden h-72 sm:h-96">
            <Image src="/images/realisations/03-buffet-led.jpg" alt="Buffet sur-mesure avec éclairage LED encastré — rénovation haut de gamme Paris 8e arrondissement" fill className="object-cover" sizes="(max-width: 768px) 100vw, 896px" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            {[
              {
                q: 'Quel est le délai pour obtenir un devis dans le 8e ?',
                a: 'Nous répondons à toutes les demandes sous 48h. Le déplacement est gratuit et sans engagement dans tout le 8e arrondissement.',
              },
              {
                q: 'Quel est le prix d\'une rénovation complète dans le 8e ?',
              ...
              {
                q: 'Quels types de travaux réalisez-vous dans le 8e ?',
