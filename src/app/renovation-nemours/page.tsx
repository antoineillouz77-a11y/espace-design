...
export const metadata: Metadata = {
  title: "Rénovation Nemours (77140) — Artisan Rénovateur | Espace Design",
  description: "Artisan rénovateur à Nemours (77140) — rénovation appartement, salle de bain, cuisine, peinture, parquet. Devis gratuit sous 48h.",
  keywords: ["rénovation Nemours", "artisan rénovation Nemours", "rénovation appartement 77140"],
}

const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: 'https://espacedesignparis.fr' }, { '@type': 'ListItem', position: 2, name: "Rénovation Nemours", item: "https://espacedesignparis.fr/renovation-nemours" }] }
const schemaLocalBusiness = { '@context': 'https://schema.org', '@type': 'HomeAndConstructionBusiness', name: 'Espace Design', description: "Artisan rénovateur à Nemours.", telephone: '+33611783867', email: 'espacedesign92@gmail.com', url: 'https://espacedesignparis.fr', address: { '@type': 'PostalAddress', addressLocality: 'Nemours', postalCode: '77140', addressCountry: 'FR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.9', reviewCount: '47' }, priceRange: '€€€' }
const schemaFAQ = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [{ '@type': 'Question', name: "Délai devis à Nemours ?", acceptedAnswer: { '@type': 'Answer', text: "Devis sous 48h après visite gratuite." } }, { '@type': 'Question', name: "Quels travaux à Nemours ?", acceptedAnswer: { '@type': 'Answer', text: "Rénovation complète, salle de bain, cuisine, peinture, parquet, carrelage, électricité, plomberie." } }, { '@type': 'Question', name: "Êtes-vous assurés ?", acceptedAnswer: { '@type': 'Answer', text: "Oui, assurance décennale et RC pro." } }, { '@type': 'Question', name: "Prix rénovation ?", acceptedAnswer: { '@type': 'Answer', text: "Dès 300€/m² rénovation légère, 700-1200€/m² complète." } }] }
...
export default function NemoursPage() {
  return (
    <>
      ...
      <section className="pt-32 pb-16 bg-[#1C1C1C] text-center px-4">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-bold text-white mb-4">Rénovation Nemours</h1>
        <p className="text-gray-400 max-w-2xl mx-auto text-base leading-relaxed">Artisan rénovateur à Nemours — appartements, maisons et locaux. Devis gratuit sous 48h.</p>
      ...
      <section className="py-14 bg-white"><div className="max-w-3xl mx-auto px-4 sm:px-6">
        <h2 className="font-display text-2xl font-semibold text-[#1C1C1C] mb-4">Artisan rénovateur à Nemours</h2>
        <p className="text-gray-600 leading-relaxed mb-4">Ville médiévale du Gâtinais au bord du Loing, Nemours abrite de nombreuses maisons de ville anciennes et pavillons qui méritent une rénovation respectueuse du patrimoine local.</p>
        <p className="text-gray-600 leading-relaxed mb-4">Espace Design intervient à Nemours pour la rénovation de votre appartement ou maison. Finitions soignées, respect du budget et des délais — déplacement gratuit, devis sous 48h.</p>
      ...
      <section className="py-12 bg-[#FAFAF8] border-t border-gray-100"><div className="max-w-5xl mx-auto px-4 sm:px-6">
        <h2 className="font-display text-xl font-semibold text-[#1C1C1C] mb-6">Nos services à Nemours</h2>
      ...
      <section className="py-16 bg-[#1C1C1C] text-center px-4">
        <h2 className="font-display text-3xl font-bold text-white mb-4">Votre projet à Nemours</h2>
        <p className="text-gray-400 mb-8 max-w-xl mx-auto text-sm">Devis gratuit sous 48h — déplacement gratuit à Nemours.</p>
