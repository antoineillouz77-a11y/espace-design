...
export const metadata: Metadata = {
  title: 'Rénovation Appartement Meudon — Artisan Rénovateur & Devis | Espace Design',
  description:
    'Artisan rénovateur à Meudon (92190). Rénovation complète, salle de bain, cuisine, finitions haut de gamme. Devis gratuit 48h. Espace Design.',
  keywords: [
    'rénovation appartement Meudon',
    'artisan rénovation Meudon 92',
    'entreprise rénovation Meudon',
    'renovation Meudon 92190',
    'artisan Meudon Hauts-de-Seine',
  ],
}
...
const schemaLocal = {
  ...
  name: 'Espace Design',
  description: 'Artisan rénovateur à Meudon (92190). Rénovation complète, salle de bain, cuisine, finitions haut de gamme.',
...
const schemaBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Rénovation Meudon', item: 'https://espacedesignparis.fr/renovation-meudon' },
  ],
}
...
const schemaFaq = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Oui. Nous intervenons à Meudon (Meudon-la-Forêt, Vélizy, Bellevue) et dans les communes voisines : Issy-les-Moulineaux, Clamart, Boulogne-Billancourt. Déplacement gratuit.',
      },
    },
    {
      '@type': 'Question',
    ...
    <>
      ...
      <section className="pt-28 sm:pt-36 pb-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-[#B8960C] text-[10px] font-light uppercase tracking-[0.25em] mb-4">Hauts-de-Seine — Meudon 92</p>
          <div className="w-8 h-px bg-[#D4AF37]/60 mx-auto mb-6" />
          <h1 className="font-display text-3xl sm:text-5xl font-semibold text-[#1C1C1C] leading-tight mb-5">
            Rénovation appartement<br className="hidden sm:block" /> Meudon
          </h1>
          <p className="text-gray-500 text-sm sm:text-base font-light max-w-2xl mx-auto mb-8 leading-relaxed">
            Artisan rénovateur à Meudon et dans les Hauts-de-Seine. Rénovation complète, salle de bain, cuisine, finitions haut de gamme. Devis gratuit sous 48h.
          </p>
      ...
      <section className="py-20 bg-[#F2F2EE]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { num: '01', title: 'Rénovation complète', desc: 'Du sol au plafond à Meudon : gros œuvre, électricité, plomberie, cloisons, isolation, finitions. Un seul artisan pour tout coordonner.' },
              { num: '02', title: 'Salle de bain & cuisine', desc: 'Conception et réalisation de salles de bain et cuisines adaptées aux maisons et appartements de caractère de Meudon.' },
              { num: '03', title: 'Finitions sur mesure', desc: 'Parquet, peinture, carrelage, menuiseries. Un savoir-faire artisanal au service de votre bien immobilier à Meudon.' },
            ].map((s) => (
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'Oui. Nous intervenons à Meudon (Meudon-la-Forêt, Vélizy, Bellevue) et dans les communes voisines : Issy-les-Moulineaux, Clamart, Boulogne-Billancourt. Déplacement gratuit.',
              },
              {
      ...
      <section className="py-20 bg-[#1C1C1C]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-400 text-sm font-light mb-8 leading-relaxed">
            Décrivez votre projet et recevez un devis gratuit et détaillé sous 48h. Déplacement sans engagement à Meudon et dans les communes voisines.
          </p>
