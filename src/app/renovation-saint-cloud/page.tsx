      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { src: '/images/realisations/05-terrasse-ciel-bleu.jpg', alt: 'Terrasse Saint-Cloud' },
              { src: '/images/realisations/10-appartement-globe.jpg', alt: 'Appartement Saint-Cloud' },
              { src: '/images/realisations/03-buffet-led.jpg', alt: 'Buffet LED Saint-Cloud' },
            ].map((img) => (
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed font-light italic mb-6">
            &ldquo;Nous avons fait rénover notre maison de Montretout par Patrick — cuisine, salles de bain, parquet dans toute la maison. Un chantier de 8 semaines géré avec une maîtrise impressionnante. Le résultat est magnifique. Nous recommandons vivement Espace Design.&rdquo;
          </p>
          <div className="text-sm font-medium text-[#1C1C1C]">Sylvie & Bernard A.</div>
          <div className="text-xs text-gray-400 font-light mt-0.5">Saint-Cloud · Quartier Montretout</div>
        </div>
      </section>
