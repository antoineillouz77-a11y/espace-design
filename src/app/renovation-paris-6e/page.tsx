...
export const metadata: Metadata = {
  title: 'Rénovation Appartement Paris 6e — Espace Design | Artisan Rénovateur',
  description:
    'Artisan rénovateur et décorateur intérieur dans le 6e arrondissement de Paris. Rénovation complète, décoration haut de gamme, sur-mesure. Devis gratuit 48h. Saint-Germain, Odéon, Vaugirard.',
  keywords: [
    'rénovation appartement Paris 6e',
    'artisan rénovation Paris 6ème',
    'décoration intérieure Paris 6e',
    'renovation Paris 6 arrondissement',
    'entreprise renovation Paris 6',
    'artisan Paris 6e arrondissement',
  ],
}
...
const schemaLocal = {
  ...
  name: 'Espace Design',
  description: 'Artisan rénovateur et décorateur intérieur dans le 6e arrondissement de Paris.',
  telephone: '+33611783867',
  url: 'https://espacedesignparis.fr/renovation-paris-6e',
  areaServed: {
...
const schemaBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Paris 6e', item: 'https://espacedesignparis.fr/renovation-paris-6e' },
  ],
}
...
const schemaFaq = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Quel est le délai pour obtenir un devis dans le 6e arrondissement ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Nous répondons à toutes les demandes de devis sous 48h. Le déplacement pour évaluer votre projet est gratuit et sans engagement dans tout le 6e arrondissement.',
      },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Quels types de travaux réalisez-vous dans le 6e arrondissement ?',
      acceptedAnswer: {
        '@type': 'Answer',
...
export default function RenovationParis6e() {
  return (
    <>
      <script
      ...
      <section className="pt-28 sm:pt-36 pb-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-[#B8960C] text-[10px] font-light uppercase tracking-[0.25em] mb-4">Paris 6e arrondissement</p>
          <div className="w-8 h-px bg-[#D4AF37]/60 mx-auto mb-6" />
          <h1 className="font-display text-3xl sm:text-5xl font-semibold text-[#1C1C1C] leading-tight mb-5">
            Rénovation appartement<br className="hidden sm:block" /> Paris 6e
          </h1>
          <p className="text-gray-500 text-sm sm:text-base font-light max-w-2xl mx-auto mb-8 leading-relaxed">
            Artisan rénovateur et décorateur intérieur dans le 6e arrondissement. Rénovation complète, décoration sur-mesure, finitions haut de gamme. Devis gratuit sous 48h.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="font-display text-2xl sm:text-3xl font-semibold text-[#1C1C1C] mb-10">
            Une réalisation dans le 6e
          </h2>
          <div className="relative rounded-xl overflow-hidden h-72 sm:h-96">
            <Image src="/images/realisations/06-salon-eclairage-theatre.jpg" alt="Salon avec éclairage architectural sur-mesure — rénovation appartement Paris 6e arrondissement" fill className="object-cover" sizes="(max-width: 768px) 100vw, 896px" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            {[
              {
                q: 'Quel est le délai pour obtenir un devis dans le 6e ?',
                a: 'Nous répondons à toutes les demandes sous 48h. Le déplacement est gratuit et sans engagement dans tout le 6e arrondissement.',
              },
              {
                q: 'Quel est le prix d\'une rénovation complète dans le 6e ?',
              ...
              {
                q: 'Quels types de travaux réalisez-vous dans le 6e ?',
      ...
      <section className="py-10 bg-[#FAFAF8] border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              { href: '/blog/renovation-appartement-saint-germain-paris', label: 'Rénover Saint-Germain-des-Prés' },
      ...
      <section className="py-20 bg-[#1C1C1C]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="font-display text-2xl sm:text-3xl font-semibold text-white mb-4">
            Votre projet dans le 6e
          </h2>
          <p className="text-gray-400 text-sm font-light mb-8 leading-relaxed">
            Décrivez votre projet et recevez un devis gratuit et détaillé sous 48h. Déplacement sans engagement dans tout le 6e arrondissement.
          </p>
