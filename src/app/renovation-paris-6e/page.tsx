      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { src: '/images/realisations/05-terrasse-ciel-bleu.jpg', alt: 'Terrasse Paris 6e' },
              { src: '/images/realisations/01-salon-parisien-bibliotheque.jpg', alt: 'Salon bibliothèque Paris 6e' },
              { src: '/images/realisations/12-salle-bain.jpg', alt: 'Salle de bain Paris 6e' },
            ].map((img) => (
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed font-light italic mb-6">
            &ldquo;Nous avons confié à Patrick la rénovation de notre appartement Rue de Vaugirard. Il a su magnifiquement préserver le caractère haussmannien du bien tout en le modernisant. Un artisan d&apos;exception.&rdquo;
          </p>
          <div className="text-sm font-medium text-[#1C1C1C]">Claire & Édouard M.</div>
          <div className="text-xs text-gray-400 font-light mt-0.5">Paris 6e · Rue de Vaugirard</div>
        </div>
      </section>
