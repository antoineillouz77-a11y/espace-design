...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'décoration intérieure Courbevoie',
    'renovation Courbevoie 92400',
    'entreprise renovation Courbevoie',
    'artisan Courbevoie hauts-de-seine',
  ],
}
...
const schemaLocal = {
  ...
  name: 'Espace Design',
  description: 'Artisan rénovateur et décorateur intérieur à Courbevoie.',
...
const schemaFaq = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Quel est le délai pour obtenir un devis à Courbevoie ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Nous répondons à toutes les demandes de devis sous 48h. Le déplacement est gratuit et sans engagement à Courbevoie et dans toute la région.',
      },
    },
    {
      '@type': 'Question',
      name: 'Quel est le prix d\'une rénovation complète à Courbevoie ?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Intervenez-vous à Courbevoie ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Oui, nous intervenons régulièrement à Courbevoie et dans toute l\'Île-de-France. Contactez-nous pour un devis gratuit sous 48h.',
      },
    },
  ],
}
...
export default function RenovationCourbevoie() {
  return (
    <>
      <script
      ...
      <section className="pt-28 sm:pt-36 pb-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-[#B8960C] text-[10px] font-light uppercase tracking-[0.25em] mb-4">Courbevoie — 92400</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="relative rounded-xl overflow-hidden h-72 sm:h-96">
            <Image src="/images/realisations/18-salon-renovation-complete.jpg" alt="Salon rénové avec finitions haut de gamme et agencement sur-mesure — rénovation appartement Courbevoie" fill className="object-cover" sizes="(max-width: 768px) 100vw, 896px" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            {[
              {
                q: 'Quel est le délai pour obtenir un devis à Courbevoie ?',
                a: 'Nous répondons à toutes les demandes sous 48h. Le déplacement est gratuit et sans engagement à Courbevoie.',
              },
              {
                q: 'Quel est le prix d\'une rénovation complète à Courbevoie ?',
              ...
              {
                q: 'Intervenez-vous à Courbevoie ?',
                a: 'Oui, nous intervenons régulièrement à Courbevoie et dans toute l\'Île-de-France. Devis gratuit sous 48h.',
              },
            ].map((item) => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              { href: '/blog/domotique-renovation-paris', label: 'Domotique rénovation' },
      ...
      <section className="py-20 bg-[#1C1C1C]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="font-display text-2xl sm:text-3xl font-semibold text-white mb-4">
            Votre projet à Courbevoie
          </h2>
          <p className="text-gray-400 text-sm font-light mb-8 leading-relaxed">
            Décrivez votre projet et recevez un devis gratuit et détaillé sous 48h. Déplacement sans engagement dans toute la commune de Courbevoie.
          </p>
