...
export const metadata: Metadata = {
  title: 'Rénovation Coulommiers (77120) — Artisan Rénovateur | Espace Design',
  description: "Artisan rénovateur à Coulommiers — rénovation appartement, salle de bain, cuisine, peinture, parquet. Devis gratuit sous 48h.",
  keywords: ['rénovation Coulommiers', 'artisan rénovation Coulommiers', 'rénovation appartement 77120'],
}
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: 'https://espacedesignparis.fr' }, { '@type': 'ListItem', position: 2, name: 'Rénovation Coulommiers', item: 'https://espacedesignparis.fr/renovation-coulommiers' }] }
const schemaLocalBusiness = { '@context': 'https://schema.org', '@type': 'HomeAndConstructionBusiness', name: 'Espace Design', description: "Artisan rénovateur à Coulommiers.", telephone: '+33611783867', email: 'espacedesign92@gmail.com', url: 'https://espacedesignparis.fr', address: { '@type': 'PostalAddress', addressLocality: 'Coulommiers', postalCode: '77120', addressCountry: 'FR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.9', reviewCount: '47' }, priceRange: '€€€' }
const schemaFAQ = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [{ '@type': 'Question', name: "Quel délai pour un devis à Coulommiers ?", acceptedAnswer: { '@type': 'Answer', text: "Devis sous 48h après visite gratuite à Coulommiers." } }, { '@type': 'Question', name: "Quels travaux à Coulommiers ?", acceptedAnswer: { '@type': 'Answer', text: "Rénovation complète, salle de bain, cuisine, peinture, parquet, carrelage, électricité, plomberie." } }, { '@type': 'Question', name: "Êtes-vous assurés ?", acceptedAnswer: { '@type': 'Answer', text: "Oui, assurance décennale et RC pro." } }, { '@type': 'Question', name: "Prix rénovation à Coulommiers ?", acceptedAnswer: { '@type': 'Answer', text: "Rénovation légère dès 300€/m², complète 700-1200€/m²." } }] }
...
export default function CoulommiersPage() {
  return (
    <>
      ...
      <section className="pt-32 pb-16 bg-[#1C1C1C] text-center px-4">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-bold text-white mb-4">Rénovation Coulommiers</h1>
        <p className="text-gray-400 max-w-2xl mx-auto text-base leading-relaxed">Artisan rénovateur à Coulommiers. Devis gratuit sous 48h.</p>
      ...
      <section className="py-14 bg-white"><div className="max-w-3xl mx-auto px-4 sm:px-6">
        <h2 className="font-display text-2xl font-semibold text-[#1C1C1C] mb-4">Artisan rénovateur à Coulommiers</h2>
        <p className="text-gray-600 leading-relaxed mb-4">Coulommiers, sous-préfecture de Seine-et-Marne, est une ville de taille moyenne avec un tissu immobilier mêlant bâti ancien du centre-bourg et résidences des années 70-2000 en périphérie.</p>
        <p className="text-gray-600 leading-relaxed mb-4">Notre équipe rénove à Coulommiers tous types de logements : rénovation complète d'appartement ou de maison, réfection de salle de bain et de cuisine. Devis gratuit sous 48h.</p>
      ...
      <section className="py-12 bg-[#FAFAF8] border-t border-gray-100"><div className="max-w-5xl mx-auto px-4 sm:px-6">
        <h2 className="font-display text-xl font-semibold text-[#1C1C1C] mb-6">Nos services à Coulommiers</h2>
      ...
      <section className="py-16 bg-[#1C1C1C] text-center px-4">
        <h2 className="font-display text-3xl font-bold text-white mb-4">Votre projet à Coulommiers</h2>
