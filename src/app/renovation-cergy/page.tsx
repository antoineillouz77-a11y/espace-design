...
export const metadata: Metadata = {
  title: 'Rénovation Cergy — Appartement & Maison (95) | Espace Design',
  description:
    'Artisan rénovateur à Cergy (95). Rénovation appartement, maison, travaux intérieurs. Devis gratuit 48h. Espace Design.',
}
...
const schemaLocalBusiness = {
  ...
  name: 'Espace Design',
  description: 'Artisan rénovateur à Cergy (95).',
...
const avantages = [
  { title: 'Ville nouvelle, bâti varié', desc: 'Cergy est une ville nouvelle conçue dans les années 70. Nos artisans connaissent les particularités de ce bâti — isolation thermique, réseaux à moderniser, agencements à repenser.' },
  { title: 'Tous types de travaux intérieurs', desc: 'Peinture, parquet, salle de bain, cuisine, cloisons : nous prenons en charge tous les corps de métier. Un seul artisan coordonne l\'ensemble pour un résultat cohérent et soigné.' },
  { title: 'Devis gratuit sous 48h', desc: 'Nous nous déplaçons gratuitement à Cergy pour estimer votre projet. Vous recevez un devis détaillé et transparent sous 48 heures, sans engagement.' },
]
  ...
  return (
    <>
      ...
      <section className="pt-28 sm:pt-36 pb-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-500 text-sm sm:text-base font-light max-w-2xl mx-auto mb-8 leading-relaxed">
            Artisan rénovateur à Cergy (95). Rénovation appartement, maison, travaux intérieurs. Devis gratuit sous 48h.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="font-display text-2xl sm:text-3xl font-semibold text-[#1C1C1C] mb-10">
            Pourquoi nous choisir pour votre rénovation à Cergy
          </h2>
      ...
      <section className="py-20 bg-[#1C1C1C]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-400 text-sm font-light mb-8 leading-relaxed">
            Décrivez votre projet et recevez un devis gratuit et détaillé sous 48h. Déplacement sans engagement à Cergy et dans tout le Val-d'Oise.
          </p>
