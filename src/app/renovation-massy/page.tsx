...
export const metadata: Metadata = {
  title: 'Rénovation Massy — Appartement & Maison (91) | Espace Design',
  description:
    'Artisan rénovateur à Massy (91). Rénovation appartement, maison, salle de bain, cuisine. Devis gratuit 48h. Espace Design.',
}
...
const schemaLocalBusiness = {
  ...
  name: 'Espace Design',
  description: 'Artisan rénovateur à Massy (91).',
...
const avantages = [
  { title: 'Expertise appartements et maisons', desc: 'Massy accueille une diversité de logements : résidences récentes, pavillons, maisons de ville. Nos artisans s\'adaptent à chaque configuration et à chaque budget.' },
  { title: 'Coordination complète du chantier', desc: 'Plomberie, électricité, carrelage, peinture : nous gérons tous les corps de métier. Vous n\'avez qu\'un seul interlocuteur du début à la fin de votre rénovation.' },
  { title: 'Devis gratuit sous 48h', desc: 'Nous nous déplaçons gratuitement à Massy pour estimer votre projet. Vous recevez un devis détaillé et transparent sous 48 heures, sans engagement.' },
]
  ...
  return (
    <>
      ...
      <section className="pt-28 sm:pt-36 pb-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-500 text-sm sm:text-base font-light max-w-2xl mx-auto mb-8 leading-relaxed">
            Artisan rénovateur à Massy (91). Rénovation appartement, maison, salle de bain, cuisine. Devis gratuit sous 48h.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="font-display text-2xl sm:text-3xl font-semibold text-[#1C1C1C] mb-10">
            Pourquoi nous choisir pour votre rénovation à Massy
          </h2>
      ...
      <section className="py-20 bg-[#1C1C1C]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-400 text-sm font-light mb-8 leading-relaxed">
            Décrivez votre projet et recevez un devis gratuit et détaillé sous 48h. Déplacement sans engagement à Massy et dans toute l'Essonne.
          </p>
