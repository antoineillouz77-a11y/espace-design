...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'décoration intérieure Boulogne-Billancourt',
    'renovation Boulogne 92100',
    'entreprise renovation Boulogne-Billancourt',
...
const schemaFaq = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Quel est le délai pour obtenir un devis à Boulogne-Billancourt ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Nous répondons à toutes les demandes de devis sous 48h. Le déplacement est gratuit et sans engagement à Boulogne-Billancourt et dans toute la région.',
      },
    },
    {
      '@type': 'Question',
      name: 'Quel est le prix d\'une rénovation complète à Boulogne-Billancourt ?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Intervenez-vous à Boulogne-Billancourt ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Oui, nous intervenons régulièrement à Boulogne-Billancourt et dans toute l\'Île-de-France. Contactez-nous pour un devis gratuit sous 48h.',
      },
    },
  ],
}
      ...
      <section className="pt-28 sm:pt-36 pb-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-500 text-sm sm:text-base font-light max-w-2xl mx-auto mb-8 leading-relaxed">
            Artisan rénovateur et décorateur intérieur à Boulogne-Billancourt. Rénovation complète, décoration sur-mesure, finitions haut de gamme. Devis gratuit sous 48h.
          </p>
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            {[
              {
                q: 'Quel est le délai pour obtenir un devis à Boulogne-Billancourt ?',
                a: 'Nous répondons à toutes les demandes sous 48h. Le déplacement est gratuit et sans engagement à Boulogne-Billancourt.',
              },
              {
                q: 'Quel est le prix d\'une rénovation complète à Boulogne-Billancourt ?',
              ...
              {
                q: 'Intervenez-vous à Boulogne-Billancourt ?',
                a: 'Oui, nous intervenons régulièrement à Boulogne-Billancourt et dans toute l\'Île-de-France. Devis gratuit sous 48h.',
              },
            ].map((item) => (
