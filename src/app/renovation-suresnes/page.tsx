...
export const metadata: Metadata = {
  title: 'Rénovation Appartement Suresnes — Espace Design | Artisan Rénovateur',
  description:
    'Artisan rénovateur à Suresnes. Rénovation complète et décoration intérieure. Devis gratuit 48h. Mont-Valérien, Bords de Seine.',
  keywords: [
    'rénovation appartement Suresnes',
    'artisan rénovation Suresnes',
    'décoration intérieure Suresnes',
    'renovation Suresnes 92150',
    'entreprise renovation Suresnes',
...
const schemaLocal = {
  ...
  name: 'Espace Design',
  description: 'Artisan rénovateur et décorateur intérieur à Suresnes.',
...
const schemaFaq = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Oui, nous intervenons régulièrement à Suresnes et dans toute l\'Île-de-France. Contactez-nous pour un devis gratuit sous 48h.',
      },
    },
  ],
}
    ...
    <>
      ...
      <section className="pt-28 sm:pt-36 pb-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-[#B8960C] text-[10px] font-light uppercase tracking-[0.25em] mb-4">Suresnes — 92150</p>
          <div className="w-8 h-px bg-[#D4AF37]/60 mx-auto mb-6" />
          <h1 className="font-display text-3xl sm:text-5xl font-semibold text-[#1C1C1C] leading-tight mb-5">
            Rénovation appartement<br className="hidden sm:block" /> Suresnes
          </h1>
          <p className="text-gray-500 text-sm sm:text-base font-light max-w-2xl mx-auto mb-8 leading-relaxed">
            Artisan rénovateur et décorateur intérieur à Suresnes. Rénovation complète, décoration sur-mesure, finitions haut de gamme. Mont-Valérien, Bords de Seine, Plateau. Devis gratuit sous 48h.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="relative rounded-xl overflow-hidden h-72 sm:h-96">
            <Image src="/images/realisations/18-salon-renovation-complete.jpg" alt="Salon rénové avec finitions haut de gamme et agencement sur-mesure — rénovation appartement Suresnes" fill className="object-cover" sizes="(max-width: 768px) 100vw, 896px" />
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'Oui, nous intervenons régulièrement à Suresnes et dans toute l\'Île-de-France. Devis gratuit sous 48h.',
              },
            ].map((item) => (
      ...
      <section className="py-20 bg-[#1C1C1C]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-400 text-sm font-light mb-8 leading-relaxed">
            Décrivez votre projet et recevez un devis gratuit et détaillé sous 48h. Déplacement sans engagement dans toute la commune de Suresnes.
          </p>
