...
const schemaBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Paris 3e', item: 'https://espacedesignparis.fr/renovation-paris-3e' },
  ],
}
...
const schemaFaq = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Quel est le délai pour obtenir un devis dans le 3e arrondissement ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Nous répondons à toutes les demandes de devis sous 48h. Le déplacement pour évaluer votre projet est gratuit et sans engagement dans tout le 3e arrondissement.',
      },
    },
    {
      '@type': 'Question',
      name: 'Quel est le prix d\'une rénovation complète dans le 3e arrondissement ?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Quels types de travaux réalisez-vous dans le 3e arrondissement ?',
      acceptedAnswer: {
        '@type': 'Answer',
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            {[
              {
                q: 'Quel est le délai pour obtenir un devis dans le 3e ?',
                a: 'Nous répondons à toutes les demandes sous 48h. Le déplacement est gratuit et sans engagement dans tout le 3e arrondissement.',
              },
              {
                q: 'Quel est le prix d\'une rénovation complète dans le 3e ?',
              ...
              {
                q: 'Quels types de travaux réalisez-vous dans le 3e ?',
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              { href: '/blog/creation-verriere-interieure-paris', label: 'Verrière intérieure' },
            ].map((l) => (
              <Link key={l.href} href={l.href} className="text-xs border border-gray-200 rounded px-3 py-1.5 text-gray-600 hover:border-[#D4AF37] hover:text-[#B8960C] transition-colors font-light">
                {l.label}
              </Link>
