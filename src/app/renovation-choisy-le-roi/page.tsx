...
export const metadata: Metadata = {
  title: 'Rénovation Appartement Choisy-le-Roi — Espace Design | Artisan Rénovateur',
  description:
    'Artisan rénovateur à Choisy-le-Roi (94600). Rénovation complète, parquet, salle de bain, cuisine, peinture. Devis gratuit 48h. Proche Vitry-sur-Seine, Ivry-sur-Seine.',
  keywords: [
    'rénovation appartement Choisy-le-Roi',
    'artisan rénovation Choisy-le-Roi',
    'renovation Choisy 94600',
    'entreprise renovation Choisy-le-Roi',
    'artisan Choisy val-de-marne',
      ...
      <section className="pt-28 sm:pt-36 pb-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="font-display text-3xl sm:text-5xl font-semibold text-[#1C1C1C] leading-tight mb-5">
            Rénovation appartement<br className="hidden sm:block" /> Choisy-le-Roi
          </h1>
          <p className="text-gray-500 text-sm sm:text-base font-light max-w-2xl mx-auto mb-8 leading-relaxed">
            Artisan rénovateur et décorateur intérieur à Choisy-le-Roi. Rénovation complète, parquet, salle de bain, cuisine, peinture. Proche Vitry-sur-Seine, Ivry-sur-Seine, Paris 13e. Devis gratuit sous 48h.
          </p>
