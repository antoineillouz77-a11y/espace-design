...
export const metadata: Metadata = {
  title: "Rénovation Montereau-Fault-Yonne (77130) — Artisan Rénovateur | Espace Design",
  description: "Artisan rénovateur à Montereau-Fault-Yonne — rénovation appartement, salle de bain, cuisine, peinture, parquet. Devis gratuit sous 48h.",
  keywords: ['rénovation Montereau-Fault-Yonne', 'artisan rénovation Montereau-Fault-Yonne', 'rénovation appartement 77130'],
}
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: 'https://espacedesignparis.fr' }, { '@type': 'ListItem', position: 2, name: 'Rénovation Montereau-Fault-Yonne', item: 'https://espacedesignparis.fr/renovation-montereau-fault-yonne' }] }
const schemaLocalBusiness = { '@context': 'https://schema.org', '@type': 'HomeAndConstructionBusiness', name: 'Espace Design', description: "Artisan rénovateur à Montereau-Fault-Yonne.", telephone: '+33611783867', email: 'espacedesign92@gmail.com', url: 'https://espacedesignparis.fr', address: { '@type': 'PostalAddress', addressLocality: 'Montereau-Fault-Yonne', postalCode: '77130', addressCountry: 'FR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.9', reviewCount: '47' }, priceRange: '€€€' }
const schemaFAQ = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [{ '@type': 'Question', name: "Quel délai pour un devis à Montereau-Fault-Yonne ?", acceptedAnswer: { '@type': 'Answer', text: "Devis sous 48h après visite gratuite à Montereau-Fault-Yonne." } }, { '@type': 'Question', name: "Quels travaux à Montereau-Fault-Yonne ?", acceptedAnswer: { '@type': 'Answer', text: "Rénovation complète, salle de bain, cuisine, peinture, parquet, carrelage, électricité, plomberie." } }, { '@type': 'Question', name: "Êtes-vous assurés ?", acceptedAnswer: { '@type': 'Answer', text: "Oui, assurance décennale et RC pro." } }, { '@type': 'Question', name: "Prix rénovation à Montereau-Fault-Yonne ?", acceptedAnswer: { '@type': 'Answer', text: "Rénovation légère dès 300€/m², complète 700-1200€/m²." } }] }
...
export default function MontereaePage() {
  return (
    <>
      ...
      <section className="pt-32 pb-16 bg-[#1C1C1C] text-center px-4">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-bold text-white mb-4">Rénovation Montereau-Fault-Yonne</h1>
        <p className="text-gray-400 max-w-2xl mx-auto text-base leading-relaxed">Artisan rénovateur à Montereau-Fault-Yonne. Devis gratuit sous 48h.</p>
      ...
      <section className="py-14 bg-white"><div className="max-w-3xl mx-auto px-4 sm:px-6">
        <h2 className="font-display text-2xl font-semibold text-[#1C1C1C] mb-4">Artisan rénovateur à Montereau-Fault-Yonne</h2>
        <p className="text-gray-600 leading-relaxed mb-4">Montereau-Fault-Yonne est une commune de Seine-et-Marne au confluent de la Seine et de l'Yonne. Son parc immobilier comprend des logements anciens du centre-ville et des résidences plus récentes en développement.</p>
        <p className="text-gray-600 leading-relaxed mb-4">Espace Design intervient à Montereau-Fault-Yonne pour vos projets de rénovation. Salle de bain, cuisine, peinture, parquet, carrelage — devis gratuit sous 48h, déplacement inclus.</p>
      ...
      <section className="py-12 bg-[#FAFAF8] border-t border-gray-100"><div className="max-w-5xl mx-auto px-4 sm:px-6">
        <h2 className="font-display text-xl font-semibold text-[#1C1C1C] mb-6">Nos services à Montereau-Fault-Yonne</h2>
