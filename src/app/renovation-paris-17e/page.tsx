      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { src: '/images/realisations/09-chambre-tete-lit.jpg', alt: 'Chambre tête de lit Paris 17e' },
              { src: '/images/realisations/03-buffet-led.jpg', alt: 'Buffet LED Paris 17e' },
              { src: '/images/realisations/10-appartement-globe.jpg', alt: 'Appartement globe Paris 17e' },
            ].map((img) => (
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed font-light italic mb-6">
            &ldquo;Excellent artisan. À l&apos;écoute, de bon conseil, et un sens du détail rare. Les finitions sont vraiment au top. Je recommande Patrick à tous mes voisins du 17e.&rdquo;
          </p>
          <div className="text-sm font-medium text-[#1C1C1C]">Karim B.</div>
          <div className="text-xs text-gray-400 font-light mt-0.5">Paris 17e · Avenue des Ternes</div>
        </div>
      </section>
