      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { src: '/images/realisations/06-salon-eclairage-theatre.jpg', alt: 'Salon éclairage Paris 18e' },
              { src: '/images/realisations/14-meuble-tv-beton.jpg', alt: 'Meuble TV béton Paris 18e' },
              { src: '/images/realisations/10-appartement-globe.jpg', alt: 'Appartement Paris 18e' },
            ].map((img) => (
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed font-light italic mb-6">
            &ldquo;Notre appartement sous les toits de Montmartre était un vrai casse-tête : pente partout, couloirs étroits, pas de salle de bain digne de ce nom. Patrick a transformé ce puzzle en un nid douillet et élégant. Travail remarquable dans des conditions difficiles.&rdquo;
          </p>
          <div className="text-sm font-medium text-[#1C1C1C]">Élodie & Marc G.</div>
          <div className="text-xs text-gray-400 font-light mt-0.5">Paris 18e · Butte Montmartre</div>
        </div>
      </section>
