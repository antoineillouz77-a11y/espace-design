      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { src: '/images/realisations/04-terrasse-vue-paris.jpg', alt: 'Terrasse vue Paris 2e' },
              { src: '/images/realisations/08-couloir-moderne.jpg', alt: 'Couloir moderne Paris 2e' },
              { src: '/images/realisations/14-meuble-tv-beton.jpg', alt: 'Meuble TV béton Paris 2e' },
            ].map((img) => (
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed font-light italic mb-6">
            &ldquo;Nous avons transformé notre ancien local commercial en appartement dans la Rue Montorgueil. Patrick a géré tout le projet avec une grande maîtrise : création des cloisons, isolation thermique, cuisine sur-mesure. Le résultat est au-delà de nos espérances.&rdquo;
          </p>
          <div className="text-sm font-medium text-[#1C1C1C]">Mathieu & Sophie R.</div>
          <div className="text-xs text-gray-400 font-light mt-0.5">Paris 2e · Rue Montorgueil</div>
        </div>
      </section>
