...
export const metadata: Metadata = {
  title: 'Rénovation Appartement Nogent-sur-Marne — Artisan & Devis | Espace Design',
  description:
    'Artisan rénovateur à Nogent-sur-Marne (94130). Rénovation complète, salle de bain, cuisine, décoration haut de gamme. Devis gratuit 48h.',
  keywords: [
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Le prix d\'une rénovation à Nogent-sur-Marne se situe entre 800 et 1 500 €/m². Nogent est une des communes les plus chères du Val-de-Marne, avec une forte demande pour des rénovations haut de gamme. Devis gratuit sous 48h.',
      },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Quels travaux réalisez-vous à Nogent-sur-Marne ?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    <>
      ...
      <section className="pt-28 sm:pt-36 pb-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-[#B8960C] text-[10px] font-light uppercase tracking-[0.25em] mb-4">Val-de-Marne — Nogent-sur-Marne 94</p>
          <div className="w-8 h-px bg-[#D4AF37]/60 mx-auto mb-6" />
          <h1 className="font-display text-3xl sm:text-5xl font-semibold text-[#1C1C1C] leading-tight mb-5">
            Rénovation appartement Nogent-sur-Marne
          </h1>
          <p className="text-gray-500 text-sm sm:text-base font-light max-w-2xl mx-auto mb-8 leading-relaxed">
            Artisan rénovateur à Nogent-sur-Marne. Rénovation complète, salle de bain, cuisine, décoration haut de gamme. Devis gratuit sous 48h.
          </p>
            ...
            {[
              {
                ...
                a: 'Le prix d\'une rénovation à Nogent-sur-Marne se situe entre 800 et 1 500 €/m². Nogent est une des communes les plus chères du Val-de-Marne, avec une forte demande pour des rénovations haut de gamme. Devis gratuit sous 48h.',
              },
              {
              ...
              {
                q: 'Quels travaux réalisez-vous à Nogent-sur-Marne ?',
