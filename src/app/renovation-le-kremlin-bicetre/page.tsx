...
const schemaLocal = {
  ...
  name: 'Espace Design',
  description: 'Artisan rénovateur et décorateur intérieur au Kremlin-Bicêtre.',
  telephone: '+33611783867',
  url: 'https://espacedesignparis.fr/renovation-le-kremlin-bicetre',
  areaServed: {
...
export default function RenovationLeKremlinBicetre() {
  return (
    <>
      <script
      ...
      <section className="pt-28 sm:pt-36 pb-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-[#B8960C] text-[10px] font-light uppercase tracking-[0.25em] mb-4">Le Kremlin-Bicêtre — 94270</p>
      ...
      <section className="py-20 bg-[#F2F2EE]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="font-display text-2xl sm:text-3xl font-semibold text-[#1C1C1C] mb-10">
            Nos services au Kremlin-Bicêtre
          </h2>
