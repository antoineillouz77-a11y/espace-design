      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { src: '/images/realisations/08-couloir-moderne.jpg', alt: 'Couloir Paris 19e' },
              { src: '/images/realisations/11-chambre-dressing.jpg', alt: 'Chambre dressing Paris 19e' },
              { src: '/images/realisations/03-buffet-led.jpg', alt: 'Buffet LED Paris 19e' },
            ].map((img) => (
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed font-light italic mb-6">
            &ldquo;Appartement Rue Botzaris entièrement rénové par Patrick. Il a ouvert la cuisine sur le salon, refait la salle de bain et posé du parquet dans toutes les pièces. Le rendu est parfait et l&apos;appartement a pris une valeur considérable. Excellent rapport qualité-prix.&rdquo;
          </p>
          <div className="text-sm font-medium text-[#1C1C1C]">Romain & Émilie S.</div>
          <div className="text-xs text-gray-400 font-light mt-0.5">Paris 19e · Buttes Chaumont</div>
        </div>
      </section>
