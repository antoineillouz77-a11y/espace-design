...
const schemaLocal = {
  ...
  name: 'Espace Design',
  description: 'Artisan rénovateur à Charenton-le-Pont (94220). Rénovation complète, salle de bain, cuisine, finitions haut de gamme.',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Le prix d\'une rénovation à Charenton-le-Pont varie entre 800 et 1 500 €/m². Charenton est une commune très prisée, adjacente à Paris 12e, avec une forte demande pour des appartements rénovés haut de gamme. Devis gratuit sous 48h.',
      },
    },
    {
      '@type': 'Question',
      name: 'Espace Design intervient-il à Charenton-le-Pont ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Oui. Charenton est une de nos zones prioritaires, adjacente à Paris. Nous intervenons aussi à Maisons-Alfort, Ivry, Saint-Mandé et dans tout le 12e arrondissement.',
      },
    },
    {
      '@type': 'Question',
      name: 'Quels travaux réalisez-vous à Charenton ?',
      acceptedAnswer: {
        '@type': 'Answer',
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              { num: '03', title: 'Finitions haut de gamme', desc: 'Menuiserie, parquet, carrelage, peinture décorative. Les détails qui transforment un intérieur ordinaire en espace exceptionnel.' },
            ].map((s) => (
            ...
            {[
              {
                ...
                a: 'Le prix d\'une rénovation à Charenton-le-Pont varie entre 800 et 1 500 €/m². Charenton est une commune très prisée, adjacente à Paris 12e, avec une forte demande pour des appartements rénovés haut de gamme. Devis gratuit sous 48h.',
              },
              {
                q: 'Espace Design intervient-il à Charenton-le-Pont ?',
                a: 'Oui. Charenton est une de nos zones prioritaires, adjacente à Paris. Nous intervenons aussi à Maisons-Alfort, Ivry, Saint-Mandé et dans tout le 12e arrondissement.',
              },
              {
                q: 'Quels travaux réalisez-vous à Charenton ?',
      ...
      <section className="py-20 bg-[#1C1C1C]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-400 text-sm font-light mb-8 leading-relaxed">
            Décrivez votre projet et recevez un devis gratuit et détaillé sous 48h. Déplacement sans engagement à Charenton-le-Pont et dans tout le Val-de-Marne.
          </p>
