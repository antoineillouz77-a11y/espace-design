...
const schemaBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Paris 5e', item: 'https://espacedesignparis.fr/renovation-paris-5e' },
  ],
}
...
const schemaFaq = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Quel est le délai pour obtenir un devis dans le 5e arrondissement ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Nous répondons à toutes les demandes de devis sous 48h. Le déplacement pour évaluer votre projet est gratuit et sans engagement dans tout le 5e arrondissement.',
      },
    },
    {
      '@type': 'Question',
      name: 'Quel est le prix d\'une rénovation complète dans le 5e arrondissement ?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Quels types de travaux réalisez-vous dans le 5e arrondissement ?',
      acceptedAnswer: {
        '@type': 'Answer',
  ...
  return (
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="font-display text-2xl sm:text-3xl font-semibold text-[#1C1C1C] mb-10">
            Une réalisation dans le 5e
          </h2>
          <div className="relative rounded-xl overflow-hidden h-72 sm:h-96">
            <Image src="/images/realisations/14-meuble-tv-beton.jpg" alt="Meuble TV béton Paris 5e" fill className="object-cover" sizes="(max-width: 768px) 100vw, 896px" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            {[
              {
                q: 'Quel est le délai pour obtenir un devis dans le 5e ?',
                a: 'Nous répondons à toutes les demandes sous 48h. Le déplacement est gratuit et sans engagement dans tout le 5e arrondissement.',
              },
              {
                q: 'Quel est le prix d\'une rénovation complète dans le 5e ?',
              ...
              {
                q: 'Quels types de travaux réalisez-vous dans le 5e ?',
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              { href: '/blog/parquet-massif-paris', label: 'Parquet massif Paris' },
