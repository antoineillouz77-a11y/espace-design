...
export const metadata: Metadata = {
  title: 'Rénovation Drancy (93700) — Artisan Rénovateur | Espace Design',
  description:
    'Artisan rénovateur à Drancy (93700). Rénovation appartement, salle de bain, cuisine, peinture, parquet. Seine-Saint-Denis. Devis gratuit sous 48h. Espace Design.',
  keywords: [
    ...
    <>
      ...
      <section className="pt-28 sm:pt-36 pb-16 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-[#B8960C] text-[10px] font-light uppercase tracking-[0.25em] mb-4">Drancy — 93700</p>
          <div className="w-8 h-px bg-[#D4AF37]/60 mx-auto mb-6" />
          <h1 className="font-display text-3xl sm:text-5xl font-semibold text-[#1C1C1C] leading-tight mb-5">
            Rénovation Drancy
          </h1>
          <p className="text-gray-500 text-sm sm:text-base font-light max-w-2xl mx-auto mb-8 leading-relaxed">
            Artisan rénovateur et décorateur intérieur à Drancy. Rénovation complète, décoration sur-mesure, finitions haut de gamme. Proche Bobigny, Aubervilliers, Le Bourget. Devis gratuit sous 48h.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="relative rounded-xl overflow-hidden h-72 sm:h-96">
            <Image src="/images/realisations/18-salon-renovation-complete.jpg" alt="Salon rénové avec finitions haut de gamme — rénovation Drancy" fill className="object-cover" sizes="(max-width: 768px) 100vw, 896px" />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              { href: '/renovation-le-blanc-mesnil', label: 'Le Bourget' },
