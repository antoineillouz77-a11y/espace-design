...
const schemaLocal = {
  ...
  name: 'Espace Design',
  description: 'Artisan rénovateur et décorateur intérieur à Andrésy.',
  telephone: '+33611783867',
  url: 'https://espacedesignparis.fr/renovation-andresy',
  areaServed: {
...
const schemaBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Andrésy', item: 'https://espacedesignparis.fr/renovation-andresy' },
  ],
}

export default function RenovationAndresy() {
  return (
    <>
      <script
