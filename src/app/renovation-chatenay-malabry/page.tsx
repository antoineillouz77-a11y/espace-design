...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'décoration intérieure Châtenay-Malabry',
...
const schemaLocal = {
  ...
  name: 'Espace Design',
  description: 'Artisan rénovateur et décorateur intérieur à Châtenay-Malabry.',
  telephone: '+33611783867',
  url: 'https://espacedesignparis.fr/renovation-chatenay-malabry',
  areaServed: {
      ...
      <section className="py-20 bg-[#F2F2EE]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="font-display text-2xl sm:text-3xl font-semibold text-[#1C1C1C] mb-10">
            Nos services à Châtenay-Malabry
          </h2>
