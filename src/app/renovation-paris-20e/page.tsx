      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { src: '/images/realisations/02-bibliotheque-led.jpg', alt: 'Bibliothèque LED Paris 20e' },
              { src: '/images/realisations/15-chambre-niche-led.jpg', alt: 'Chambre niche LED Paris 20e' },
              { src: '/images/realisations/07-open-space-cuisine.jpg', alt: 'Open space Paris 20e' },
            ].map((img) => (
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed font-light italic mb-6">
            &ldquo;On a acheté un appartement Rue de Ménilmontant qui était dans son jus depuis 30 ans. Patrick l&apos;a complètement transformé en 6 semaines : tout refait, tout repensé. Le résultat est bluffant. On est ravis d&apos;avoir fait confiance à Espace Design.&rdquo;
          </p>
          <div className="text-sm font-medium text-[#1C1C1C]">Florian & Amandine K.</div>
          <div className="text-xs text-gray-400 font-light mt-0.5">Paris 20e · Ménilmontant</div>
        </div>
      </section>
