...
export const metadata: Metadata = {
  title: "Rénovation Fleury-Mérogis (91700) — Artisan Rénovateur | Espace Design",
  description: "Artisan rénovateur à Fleury-Mérogis (91700) — rénovation appartement, salle de bain, cuisine, peinture, parquet. Devis gratuit sous 48h.",
  keywords: ["rénovation Fleury-Mérogis", "artisan rénovation Fleury-Mérogis", "rénovation appartement 91700"],
}
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: 'https://espacedesignparis.fr' }, { '@type': 'ListItem', position: 2, name: "Rénovation Fleury-Mérogis", item: "https://espacedesignparis.fr/renovation-fleury-merogis" }] }
const schemaLocalBusiness = { '@context': 'https://schema.org', '@type': 'HomeAndConstructionBusiness', name: 'Espace Design', description: "Artisan rénovateur à Fleury-Mérogis.", telephone: '+33611783867', email: 'espacedesign92@gmail.com', url: 'https://espacedesignparis.fr', address: { '@type': 'PostalAddress', addressLocality: 'Fleury-Mérogis', postalCode: '91700', addressCountry: 'FR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.9', reviewCount: '47' }, priceRange: '€€€' }
const schemaFAQ = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [{ '@type': 'Question', name: "Délai devis à Fleury-Mérogis ?", acceptedAnswer: { '@type': 'Answer', text: "Devis sous 48h après visite gratuite." } }, { '@type': 'Question', name: "Quels travaux à Fleury-Mérogis ?", acceptedAnswer: { '@type': 'Answer', text: "Rénovation complète, salle de bain, cuisine, peinture, parquet, carrelage, électricité, plomberie." } }, { '@type': 'Question', name: "Êtes-vous assurés ?", acceptedAnswer: { '@type': 'Answer', text: "Oui, assurance décennale et RC pro." } }, { '@type': 'Question', name: "Prix rénovation ?", acceptedAnswer: { '@type': 'Answer', text: "Dès 300€/m² rénovation légère, 700-1200€/m² complète." } }] }
...
export default function FleuryMerogisPage() {
  return (
    <>
      ...
      <section className="pt-32 pb-16 bg-[#1C1C1C] text-center px-4">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-bold text-white mb-4">Rénovation Fleury-Mérogis</h1>
        <p className="text-gray-400 max-w-2xl mx-auto text-base leading-relaxed">Artisan rénovateur à Fleury-Mérogis — appartements, maisons et locaux. Devis gratuit sous 48h.</p>
      ...
      <section className="py-14 bg-white"><div className="max-w-3xl mx-auto px-4 sm:px-6">
        <h2 className="font-display text-2xl font-semibold text-[#1C1C1C] mb-4">Artisan rénovateur à Fleury-Mérogis</h2>
        <p className="text-gray-600 leading-relaxed mb-4">Commune de l'Essonne entre Sainte-Geneviève-des-Bois et Évry, Fleury-Mérogis est composée de lotissements pavillonnaires des années 70-80 demandant modernisation. Espace Design accompagne les habitants dans la rénovation de leurs maisons et appartements, avec des solutions adaptées à chaque budget.</p>
        <p className="text-gray-600 leading-relaxed mb-4">Espace Design intervient à Fleury-Mérogis pour la rénovation de votre appartement ou maison. Finitions soignées, respect du budget et des délais — déplacement gratuit, devis sous 48h.</p>
      ...
      <section className="py-12 bg-[#FAFAF8] border-t border-gray-100"><div className="max-w-5xl mx-auto px-4 sm:px-6">
        <h2 className="font-display text-xl font-semibold text-[#1C1C1C] mb-6">Nos services à Fleury-Mérogis</h2>
      ...
      <section className="py-16 bg-[#1C1C1C] text-center px-4">
        <h2 className="font-display text-3xl font-bold text-white mb-4">Votre projet à Fleury-Mérogis</h2>
        <p className="text-gray-400 mb-8 max-w-xl mx-auto text-sm">Devis gratuit sous 48h — déplacement gratuit à Fleury-Mérogis.</p>
